...
%
% - Therefore, when plot_contrast_effect.m uses a full-trial single window
%   and saves old filenames, this script will automatically use those files.
%
...
% the old filename, this script will load the old filename.
analysis_window = 0.2;
sliding_step    = 0.2;
...
% single window and therefore intentionally saved old filenames.
...
% These fields are expected to be the same, but old file versions may not
% contain them, or minor differences may not invalidate plotting.
